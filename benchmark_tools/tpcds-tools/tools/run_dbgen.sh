...
./dsdgen -scale "$scale_factor" -suffix '.csv' -terminate n -force y

#Change the encoding of customers.csv
iconv -f ISO-8859-1 -t UTF-8 customer.csv > output_file.csv && mv output_file.csv customer.csv
